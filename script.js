...
const perguntas = [
    {
        ...
        alternativas: [
           { 
            texto: "Ele deve recorrer aos unicos parentes vivos de Harry",
            afirmacao: "afirmacao"
           }
           {
            texto: "Ele deve permitir que alguem da Ordem da Fenix adote-o",
            afirmacao: "afirmacao"
           }
        ]
    },
    {
        ...
        alternativas: [
            {
                texto: "Harry deve levar a carta até a cozinha, onde sua familia possa ver a carta.",
                afirmacao: "afirmacao"
            }
            {
                texto: "Harry deve esconder a carta e abrir sob o armário em beixo da escadaa noite, onde ninguém possa ve-la.",
                afirmacao: "afrimacao"
            }
        ]
    }

    {
        ...
        alternativas: [
            {
                texto: "Harry se junta a aventura no mundo bruxo com Hagrid",
                afrimacao: "afirmacao"
            }
            {
                texto: "Harry decide que não é a melhor ecolha se fazer, se juntando com tios novamente.",
                afirmacao: "afrimacao"
            }
        ]
    },
    {
        ...
        alternativas: [
            ...
            {
                texto: "Harry deve se esconder e deixa o mundo bruxo sofrer com a volta Daquele-Que-Não-Deve-Ser-Nomeado",
                afirmacao: "afirmacao"
            }
        ]
    }
...
function mostraAlternativas() { 
    for(const alternativa of perguntaAtual.alternativas) { 
        ...
        botaoAlternativas.textContent = alternativa.texto; // Ajustado: adicionado "="
